...
* @param $diff int внутренняя переменная функции, содержит разницу во времени (количество секунд) между текущим времененм и временем, переданным в переменной $date
*
